...
import type { CreateBuildRequest } from "../../lib/api/buildsInterfaces";
...
interface AddBuildModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: CreateBuildRequest) => void;
...
export function AddBuildModal({
    ...
    const handleSubmit = (formEvent: FormEvent) => {
        ...
        if(!buildName.trim() || !selectedCharacterID) {
            return;
        }
            ...
            <div className="modalContent modalContentWide" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="modalForm">
                    <div className="formGroup">
                        ...
                        <input
                            type="text" id="buildName" value={buildName}
                    ...
                    <div className="formGroup">
                        <label htmlFor="buildCharacter">Character *</label>
                        <select
                            id="buildCharacter"
                    ...
                    <div className="buildArtifactSelects">
                        <div className="formGroup">
                            <label htmlFor="buildFlower">Flower</label>
                            <select
                                id="buildFlower"
                        ...
                        <div className="formGroup">
                            <label htmlFor="buildFeather">Feather</label>
                            <select
                                id="buildFeather"
                        ...
                        <div className="formGroup">
                            <label htmlFor="buildSands">Sands</label>
                            <select
                                id="buildSands"
                        ...
                        <div className="formGroup">
                            <label htmlFor="buildGoblet">Goblet</label>
                            <select
                                id="buildGoblet"
                        ...
                        <div className="formGroup">
                            <label htmlFor="buildCirclet">Circlet</label>
                            <select
                                id="buildCirclet"
